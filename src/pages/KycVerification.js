...
const kycDataByRole = {
  ...
  'Promoters': {
    ...
    persons: [
      { name: 'Anish', initial: 'A', color: '#3b82f6', code: 'KA-PR-003', role: 'Promoter', location: 'Mysore', kycStatus: 'KYC Pending', heldAmount: '16,000', heldLabel: 'Held Commission' },
      { name: 'Rahul', initial: 'R', color: '#ef4444', code: 'KA-PR-004', role: 'Promoter', location: 'Mysore', kycStatus: 'KYC Pending', heldAmount: '20,000', heldLabel: 'Held Commission' },
    ],
  },
};
...
const overviewData = [
  ...
  { sl: 6, level: 'Promoter', name: 'Ankit', code: 'KA-PR-006', district: 'Mysuru/ Nanjungud', held: '20,000', aadhar: true, pan: true, bank: false, status: 'Pending' },
];
